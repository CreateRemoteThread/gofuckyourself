...
scope.glitch.repeat = 5  # was 105 for blind glitching
...
for i in range(0,128):
  ...
  try:
    ...
    print "Error: %s" % str(e)
  # plt.plot(scope.getLastTrace())
  # plt.show()
  if len(descriptor_data) == 0:
    print "Partial win, descriptor is empty"
  if descriptor_data != sanity and len(descriptor_data) != 0:
